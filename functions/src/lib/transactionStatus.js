  ...
  if (role === ROLE.ADMIN) {
    switch (workflowStatus) {
      ...
      case STATUS.PAYMENT_PENDING_ADMIN_CONFIRMATION:
        return [ACTION.CONFIRM_PAYMENT, ACTION.REVIEW_PAYMENT, ACTION.RESET, ACTION.VIEW_DETAILS];
      case STATUS.PAYMENT_UNDER_REVIEW:
        return [ACTION.CONFIRM_PAYMENT, ACTION.REJECT_PAYMENT_CLAIM, ACTION.RESET, ACTION.VIEW_DETAILS];
      default:
        return [ACTION.VIEW_DETAILS];
    }
  }

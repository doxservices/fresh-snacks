  ...
  if (role === ROLE.ADMIN) {
    switch (workflowStatus) {
      ...
      case STATUS.ITEM_UNDER_REVIEW:
        return [ACTION.EDIT_AND_RESEND, ACTION.APPROVE_ITEM, ACTION.CANCEL, ACTION.VIEW_DETAILS];
      case STATUS.CONFIRMED_UNPAID:
        return [ACTION.EDIT, ACTION.MARK_AS_PAID, ACTION.CANCEL, ACTION.VIEW_DETAILS];
      case STATUS.PAYMENT_PENDING_ADMIN_CONFIRMATION:
        return [ACTION.CONFIRM_PAYMENT, ACTION.REVIEW_PAYMENT, ACTION.VIEW_DETAILS];
      case STATUS.PAYMENT_UNDER_REVIEW:
        return [ACTION.CONFIRM_PAYMENT, ACTION.REJECT_PAYMENT_CLAIM, ACTION.VIEW_DETAILS];
      default:
        return [ACTION.VIEW_DETAILS];
    }
  }
